 ...
 *
 * Represents Forrst error code INVALID_ARGUMENTS for invalid relationship specifications in
 ...
 *
 * Results in HTTP 422 status with details about which relationships are invalid and
 * which relationships are permitted (or if none are available).
 *
...
final class InvalidRelationshipsException extends AbstractRequestException
{
     ...
     * generates a Forrst compliant error response. Handles both scenarios where
