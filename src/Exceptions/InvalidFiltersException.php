 ...
 *
 * Represents Forrst error code INVALID_ARGUMENTS for invalid filter specifications. This
 ...
 *
 * Results in HTTP 422 status with details about which filters are invalid and which
...
final class InvalidFiltersException extends AbstractRequestException
{
     ...
     * Forrst compliant error response. The error details which filters are not
